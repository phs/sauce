#ifndef SAUCE_SAUCE_INTERNAL_INJECTIONS_INJECTOR_BINDING_H_
#define SAUCE_SAUCE_INTERNAL_INJECTIONS_INJECTOR_BINDING_H_
...
#endif // SAUCE_SAUCE_INTERNAL_INJECTIONS_NAKED_BINDING_H_
