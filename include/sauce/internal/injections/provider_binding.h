#ifndef SAUCE_INTERNAL_INJECTIONS_PROVIDER_BINDING_H_
#define SAUCE_INTERNAL_INJECTIONS_PROVIDER_BINDING_H_
...
#endif // SAUCE_INTERNAL_INJECTIONS_PROVIDER_BINDING_H_
