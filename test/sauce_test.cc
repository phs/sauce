...
namespace sauce { namespace testing {
  ...
  public:
    ...
    static ::sauce::internal::bindings::NewBinding<Injector, CoupChasis()> * bindings(Chasis *) {
      return 0;
    }

    template<typename Injector>
    static ::sauce::internal::bindings::DereferenceBinding<Injector, Chasis> * bindings(Chasis &) {
      return 0;
    }

    template<typename Injector>
    static ::sauce::internal::bindings::NewBinding<Injector, HybridEngine()> * bindings(Engine *) {
      return 0;
    }

    template<typename Injector>
    static ::sauce::internal::bindings::NewBinding<Injector, Herbie(Chasis &, Engine &)> * bindings(Vehicle *) {
      return 0;
    }
